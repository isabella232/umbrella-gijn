...
<div class="global-nav-bg">
	<div class="global-nav">
		<nav id="top-nav" class="span12">
			...
			?>
			<ul class="lang-nav">
				<li class="eng"><a href="http://gijc2013.org"><img src="<?php echo get_stylesheet_directory_uri(); ?>/img/england.png" alt="English" /></a></li>
				<li class="eng"><a href="http://br.gijc2013.org"><img src="<?php echo get_stylesheet_directory_uri(); ?>/img/brazil.png" alt="Portuguese" /></a></li>
				<li class="eng"><a href="http://colpin.ipys.org/"><img src="<?php echo get_stylesheet_directory_uri(); ?>/img/spain.png" alt="Spanish" /></a></li>
			</ul>
        	<div class="nav-right">
