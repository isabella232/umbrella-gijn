		...
		<div class="entry-content">
			<div id="sched-container">
				<?php if (is_page('speakers')) { ?>
					<a id="sched-embed"  href="http://gijc13.sched.org/directory/speakers">View the gijc13 mobile app</a>
				<?php } else { ?>
					<a id="sched-embed"  href="http://gijc13.sched.org/">View the gijc13 mobile app</a>
				<?php } ?>
			</div>
		<script type="text/javascript" src="http://gijc13.sched.org/js/embed.js"></script>
		</div><!-- .entry-content -->
