...
class largo_follow_widget_gijn extends WP_Widget {

	/**
	 * Widget setup.
	 */
	function largo_follow_widget_gijn() {
		/* Widget settings. */
		$widget_ops = array(
		...
		/* Create the widget. */
		$this->WP_Widget( 'largo-follow-widget-gijn', __('Largo Follow - GIJN', 'largo'), $widget_ops );
	}
	...
	function widget( $args, $instance ) {
		...
		if ( $title )
			...
			<a class="subscribe" href="http://eepurl.com/nl3Fn"><i class="icon-mail"></i>Subscribe to Our Newsletter</a>

			<a class="subscribe" href="https://po.missouri.edu/cgi-bin/wa?A0=GLOBAL-L"><i class="icon-mail"></i>Join the GIJN Listserv</a>
